# Graph Report - dataseed-multibranch-snapshot-zuxvej6l  (2026-07-06)
...
- `is_allowed_path()` --calls--> `PurePosixPath`  [INFERRED]
  _shared/scripts/generate-multibranch-graph.py → branches/feat/task-tracking-system/scripts/update-multibranch-graph.py
- `is_allowed_path()` --calls--> `PurePosixPath`  [INFERRED]
  branches/main/scripts/generate-multibranch-graph.py → branches/feat/task-tracking-system/scripts/update-multibranch-graph.py
- `safe_member_name()` --calls--> `PurePosixPath`  [INFERRED]
  branches/main/scripts/generate-multibranch-graph.py → branches/feat/task-tracking-system/scripts/update-multibranch-graph.py
...
Cohesion: 0.25
Nodes (7): Plan de autenticación DataSeed, Archivos implementados, Decisión arquitectónica, Estado: v2 Production Ready (rama `feat/supabase-auth-production`), Pendientes para producción, Roles de usuario, Seguridad implementada
...
Cohesion: 0.29
Nodes (6): Decisión recomendada, Estado, Estado original observado, Próxima acción, Riesgo, Plan de autenticación DataSeed
