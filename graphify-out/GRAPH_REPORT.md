# Graph Report - dataseed-multibranch-snapshot-bclgl1q4  (2026-09-08)

## Corpus Check
- 323 files · ~324,337 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2840 nodes · 3908 edges · 297 communities (224 shown, 73 thin omitted)
...
2. `methodNotAllowed()` - 40 edges
3. `AuthorizationError` - 34 edges
4. `sendJson()` - 30 edges
5. `getHeader()` - 28 edges
6. `isSameOriginRequest()` - 26 edges
7. `parseCookies()` - 21 edges
8. `main()` - 20 edges
9. `Resumen 2026-06-17` - 20 edges
10. `parseRequestBody()` - 17 edges
...
- `createPublicaLogoutHandler()` --calls--> `getHeader()`  [INFERRED]
  branches/fix/publica-function-count/api/auth/_lib/publica-handlers/logout.js → _shared/api/auth/_lib/http.js
- `createPublicaSignupHandler()` --calls--> `getHeader()`  [INFERRED]
  branches/fix/publica-signup-confirm-redirect/api/auth/_lib/publica-handlers/signup.js → _shared/api/auth/_lib/http.js
...
## Communities (297 total, 73 thin omitted)
...
Cohesion: 0.08
Nodes (39): Recorta el plural castellano mas comun. NO es un stemmer.      Como el match es, Quita tildes del lado de la CONSULTA.      Tiene que existir aunque el campo ya, Parte la consulta en palabras normalizadas, sin duplicados ni ruido., Base de busqueda: indice FTS + arbol UNSPSC. Se reconstruye en cada sync.      V, Aplica la regla del umbral del SDD 5.1 a metricas.competencia.      [BUG 2026-09, Filtros que no son de texto, sobre licitacion_texto., Las tres capas, en union. Devuelve (cte_sql, params).      UNION y no intersecci, Arma el WHERE. Devuelve (sql, params, tokens).      La busqueda es DETERMINISTA (+31 more)
...
Cohesion: 0.17
Nodes (16): createPublicaLoginHandler(), createPublicaSignupHandler(), normalizeEmpresa(), createPublicaSignupHandler(), normalizeEmpresa(), normalizeEmail(), parseRequestBody(), ensureOrganizationForUser() (+8 more)
...
Cohesion: 0.19
Nodes (15): createSessionHandler(), identity, createPublicaLogoutHandler(), createPublicaSessionHandler(), authenticate(), methodNotAllowed(), sendJson(), clearSessionCookies() (+7 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (10): membershipA, membershipB, config, createLoginHandler(), identity, assertOrganizationAccess(), defaultProvider, resolveIdentity() (+2 more)
...
Cohesion: 0.20
Nodes (15): createGoogleStartHandler(), resolveOrigin(), config, createGoogleStartHandler(), resolveOrigin(), getHeader(), isSameOriginRequest(), setNoStore() (+7 more)
...
Cohesion: 0.14
Nodes (9): config, createPortalHandler(), escapeHtml(), portalHtml(), setSecurityHeaders(), identity, identity, AuthorizationError (+1 more)
...
Cohesion: 0.27
Nodes (10): createGoogleCallbackHandler(), redirect(), config, createGoogleCallbackHandler(), redirect(), buildSessionCookies(), clearOAuthVerifierCookie(), serializeCookie() (+2 more)
...
## Knowledge Gaps
- **1301 isolated node(s):** `defaultProvider`, `RESERVED_KEYS`, `config`, `config`, `config` (+1296 more)
...
- **Why does `Daily Summary - Demeter` connect `Community 0` to `Community 260`, `Community 261`, `Community 262`, `Community 263`, `Community 264`, `Community 265`, `Community 266`, `Community 267`, `Community 268`, `Community 269`, `Community 270`, `Community 271`, `Community 272`, `Community 273`, `Community 274`, `Community 275`, `Community 276`, `Community 277`, `Community 278`, `Community 31`, `Community 44`, `Community 200`, `Community 77`, `Community 78`, `Community 219`, `Community 220`, `Community 221`, `Community 222`, `Community 98`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Resumen 2026-06-17` connect `Community 31` to `Community 0`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `Resumen 2026-06-14 (recuperado)` connect `Community 44` to `Community 0`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Are the 11 inferred relationships involving `methodNotAllowed()` (e.g. with `createGoogleStartHandler()` and `createPublicaLoginHandler()`) actually correct?**
  _`methodNotAllowed()` has 11 INFERRED edges - model-reasoned connections that need verification._
- **Are the 6 inferred relationships involving `getHeader()` (e.g. with `createGoogleCallbackHandler()` and `resolveOrigin()`) actually correct?**
  _`getHeader()` has 6 INFERRED edges - model-reasoned connections that need verification._
