# Graph Report - dataseed-multibranch-snapshot-0xt1r0al  (2026-07-31)

## Corpus Check
- 209 files · ~161,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1823 nodes · 2387 edges · 200 communities (159 shown, 41 thin omitted)
...
1. `Daily Summary - Demeter` - 47 edges
2. `main()` - 20 edges
3. `Resumen 2026-06-17` - 20 edges
4. `Resumen 2026-06-14 (recuperado)` - 17 edges
5. `build_backup_md()` - 14 edges
6. `build_backup_md()` - 14 edges
7. `build_backup_md()` - 14 edges
8. `Pública AI by Dataseed — Estrategia de Producto` - 14 edges
9. `Backup operativo no sensible — DataSeed / Demeter` - 14 edges
10. `AuthorizationError` - 13 edges
...
Cohesion: 0.06
Nodes (50): config, createPortalHandler(), escapeHtml(), portalHtml(), setSecurityHeaders(), env, membershipA, membershipB (+42 more)
...
Cohesion: 0.09
Nodes (55): Any, datetime, assert_no_secret_values(), backup_outputs_summary(), build_backup_md(), build_completed_cycles_md(), build_python_compat_wrapper(), build_restore_guide() (+47 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (51): ensure_git_auth(), Discard stale generated output in the dedicated backup clone before pull.      T, Load explicit human approvals for hard-copying cron scripts.      The file is in, Copy explicitly approved, non-sensitive cron scripts into scripts/cron/.      If, Copy non-sensitive graphify output files to the backup repo., Copy canonical daily-operation scripts plus compatibility wrappers., read_dotenv_key(), Any (+43 more)
...
Cohesion: 0.06
Nodes (31): 2026-06-17, 2026-06-18, 2026-06-29 14:37 - Daniel Caignet, 2026-06-29 14:39 - Daniel Caignet, 2026-06-29 15:03 - Daniel Caignet, 2026-06-29 15:04 - Daniel Caignet, 2026-06-29 15:33 - Daniel Caignet, 2026-06-29 15:33 - Daniel Caignet (+23 more)
...
Cohesion: 0.12
Nodes (18): clip_text(), disable_direct_git_credentials(), extract_backup_note(), first_alert_line(), log_line(), normalize_agent_vault_git_env(), print_report(), run_step() (+10 more)
...
Cohesion: 0.18
Nodes (10): 2026-07-30 15:02 -04 — Crear sistema de reportes interárea en Google Drive, 2026-07-30 15:52 -04 — Corregir reportes a formato documento, 2026-07-30 16:16 -04 — Compartir carpeta de reportes y avisar por correo, 2026-07-30 16:51 -04 — Automatizar reportes diarios por área desde el task-log, 2026-07-30 16:58 -04 — Restaurar el cronjob crítico de las 05:00 Chile, 2026-07-30 17:12 -04 — Unificar reportes y limpieza en el cronjob de las 05:00, 2026-07-30 17:31 -04 — Reservar Drive exclusivamente para reportes, 2026-07-30 17:43 -04 — Exigir plantillas canónicas en todo reporte (+2 more)
...
## Knowledge Gaps
- **902 isolated node(s):** `defaultProvider`, `config`, `config`, `config`, `config` (+897 more)
...
- **Why does `Daily Summary - Demeter` connect `Community 9` to `Community 64`, `Community 136`, `Community 16`, `Community 145`, `Community 146`, `Community 48`, `Community 49`, `Community 147`, `Community 148`, `Community 23`, `Community 177`, `Community 178`, `Community 179`, `Community 180`, `Community 181`, `Community 182`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Resumen 2026-06-17` connect `Community 16` to `Community 9`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Resumen 2026-06-14 (recuperado)` connect `Community 23` to `Community 9`?**
