...
- Generado UTC: 2026-08-29 09:01:02 UTC
- Generado America/Santiago: 2026-08-29 05:01:02 -04
...
- Repo/branch de tracking: `/tmp/tmp.a1cHCRXRMI/tracking-workspace` / `feat/task-tracking-system`.
...
- Disk snapshot:
  ...
  `/dev/sda1        96G   35G   62G  36% /opt/data`
...
- `2073a6cc3d6e` [active]
  ...
  - Schedule: 0 8,9 * * *
  - Next run UTC: 2026-08-30T08:00:00+00:00
  - Last run UTC/status: 2026-08-29T08:00:52.908692+00:00 / ok
  - Mode: no-agent
...
- `channel_directory.json`: 67.0 B, sha256 7e92aafc93367740
- `gateway_state.json`: 548.0 B, sha256 c6e2d9655e06370b
- `cron/jobs.json`: 4.2 KB, sha256 7f67d273db83307d
