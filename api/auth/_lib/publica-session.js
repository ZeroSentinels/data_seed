// Resuelve/renueva la sesión de Pública a partir de las cookies __Host-pub_*.
// Misma lógica que _lib/session.js, pero leyendo la sesión independiente de
// Pública. No modifica _lib/session.js.
...
export async function authenticatePublicaRequest(req, {
  env = process.env,
