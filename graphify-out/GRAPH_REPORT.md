# Graph Report - dataseed-multibranch-snapshot-ob3q8fxs  (2026-09-09)

## Corpus Check
- 356 files · ~344,024 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2977 nodes · 4164 edges · 313 communities (236 shown, 77 thin omitted)
...
1. `Daily Summary - Demeter` - 142 edges
2. `AuthorizationError` - 47 edges
3. `methodNotAllowed()` - 46 edges
4. `sendJson()` - 38 edges
5. `isSameOriginRequest()` - 36 edges
6. `getHeader()` - 32 edges
7. `parseRequestBody()` - 27 edges
8. `parseCookies()` - 23 edges
9. `normalizeEmail()` - 21 edges
10. `main()` - 20 edges
...
- `createGoogleCallbackHandler()` --calls--> `getHeader()`  [INFERRED]
  branches/fix/publica-router-rewrite/api/auth/_lib/publica-handlers/google-callback.js → _shared/api/auth/_lib/http.js
...
Cohesion: 0.02
Nodes (113): 2026-06-17, 2026-06-18, 2026-06-29 14:37 - Daniel Caignet, 2026-06-29 14:39 - Daniel Caignet, 2026-06-29 15:03 - Daniel Caignet, 2026-06-29 15:04 - Daniel Caignet, 2026-06-29 15:33 - Daniel Caignet, 2026-06-29 15:33 - Daniel Caignet (+105 more)
...
Cohesion: 0.08
Nodes (39): Relevancia sin modelo: lo que coincide en el NOMBRE va primero.      Una licitac, Una sola pasada de las tres capas, materializada en una tabla temporal.      [ME, Capa 1 sola, sobre el almacen. Es el camino de degradacion cuando el     indice, Historia de precio del mismo rubro. rubro = unspsc_commodity (SDD 4.1b).      In, Aplica las reglas de umbral del SDD 5.1 y 5.2.      n < 3  -> nada de lenguaje e, Almacen, _armar_ref(), _as_of() (+31 more)
...
Cohesion: 0.06
Nodes (16): config, createBuscarHandler(), config, createLicitacionHandler(), membershipA, membershipB, env, identity (+8 more)
...
Cohesion: 0.23
Nodes (25): config, createLoginHandler(), createPublicaSignupHandler(), normalizeEmpresa(), createPublicaLoginHandler(), createPublicaSignupHandler(), normalizeEmpresa(), createPublicaLoginHandler() (+17 more)
...
Cohesion: 0.10
Nodes (16): identity, favoritoValido, identity, createPublicaSessionHandler(), setNoStore(), clearSessionCookies(), serializeCookie(), authenticatePublicaRequest() (+8 more)
...
Cohesion: 0.13
Nodes (23): createLogoutHandler(), createGoogleStartHandler(), resolveOrigin(), createPublicaLogoutHandler(), createGoogleStartHandler(), resolveOrigin(), authenticate(), config (+15 more)

### Community 21 - "Community 21"
Cohesion: 0.13
Nodes (14): env, config, env, config, createSessionHandler(), identity, buildSessionCookies(), clearSessionCookies() (+6 more)
...
Cohesion: 0.24
Nodes (6): identity, config, createGoogleCallbackHandler(), redirect(), config, createPublicaSessionHandler()
...
Cohesion: 0.18
Nodes (10): La sonda: el control detectivo que faltaba, `orden`: el defecto es `reciente`, y es deliberado, Una clave desconocida es un 400, no una busqueda, Verificada corriendo, los cuatro caminos, `Busqueda._abrir()` cierra antes de abrir — y por qué importa, Correr las sondas, Degradación, Lo que NO está acá (+2 more)
...
Cohesion: 0.29
Nodes (6): `Busqueda._abrir()` cierra antes de abrir — y por qué importa, Correr las sondas, Degradación, Lo que NO está acá, `mp-api` — backend del buscador de licitaciones, Por qué el índice vive en una base aparte
...
## Knowledge Gaps
- **1346 isolated node(s):** `defaultProvider`, `RESERVED_KEYS`, `config`, `config`, `config` (+1341 more)
...
- **Why does `Daily Summary - Demeter` connect `Community 0` to `Community 273`, `Community 274`, `Community 275`, `Community 276`, `Community 277`, `Community 278`, `Community 279`, `Community 280`, `Community 281`, `Community 282`, `Community 283`, `Community 284`, `Community 285`, `Community 286`, `Community 287`, `Community 288`, `Community 289`, `Community 290`, `Community 291`, `Community 31`, `Community 44`, `Community 77`, `Community 78`, `Community 209`, `Community 227`, `Community 228`, `Community 229`, `Community 101`, `Community 230`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `AuthorizationError` connect `Community 7` to `Community 134`, `Community 15`, `Community 79`, `Community 18`, `Community 20`, `Community 21`, `Community 53`, `Community 86`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Resumen 2026-06-22` connect `Community 77` to `Community 0`?**
